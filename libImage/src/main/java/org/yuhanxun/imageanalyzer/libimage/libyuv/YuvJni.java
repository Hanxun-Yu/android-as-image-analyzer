...
public class YuvJni {
    ...
    public static native void argb8888ToYuvNV21(byte[] src, byte[] target, int width, int height);
    public static native void argb8888ToYuvNV12(byte[] src, byte[] target, int width, int height);
